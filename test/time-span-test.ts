...
describe("tryParse specification", () => {
	...
	it("with integer/float string value.", () => {
		expect(TimeSpan.tryParse("121").totalMilliseconds).to.be.equal(121);
		expect(TimeSpan.tryParse(" 121  ").totalMilliseconds).to.be.equal(121);
		expect(TimeSpan.tryParse("-121").totalMilliseconds).to.be.equal(-121);
	...
	it("with valid value for pattern [+-][days.]hh:mm:ss[.milliseconds].", () => {
	...
	it("with invalid value for pattern [+-][days.]hh:mm:ss[.milliseconds].", () => {
